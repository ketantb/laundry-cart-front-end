...
const Products = (props) => {
  ...
  const GconfirmOrderSum = async () => {
    ...
    const res = await fetch("https://lc-backend.onrender.com/createorder", {
      method: "POST",
      headers: {
          ...
          <table className="tableprv">
            ...
            <tbody className="tableBody">
              <tr className="mainRow">
                ...
                <td>
                  <input className="qunatity" onChange={(e) => { setCount1({ ...count1, sc: e.target.value }); }} type="number" min="0" maxLength="4" size="2" placeholder="0" />
                </td>
                <td>
                  <img alt="pictures" className="icon" onClick={() => count1.sc && setCount1({
                    ...count1, m: !count1.m, btn: 1, bill: count1.bill + 1 * 5,
                    total: rowTotal(count1.total, count1.m, count1.sc),
                  })} id="icon1" src={count1.m ? Bluemachine : Washmach} />
                </td>
                <td>
